 ...
 */
suspend fun MemberBehavior.move(channel: VoiceChannel) = edit { voiceChannelId = channel.id }

/**
 * Disconnect this member from their voice channel.
 */
suspend fun MemberBehavior.disconnectVoice() = edit { voiceChannelId = null }
