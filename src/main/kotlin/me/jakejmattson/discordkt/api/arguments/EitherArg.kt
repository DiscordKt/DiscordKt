...
class EitherArg<L, R>(val left: ArgumentType<L>, val right: ArgumentType<R>, name: String = "") : ArgumentType<Either<L, R>>() {
    ...
    override suspend fun convert(arg: String, args: List<String>, event: GlobalCommandEvent<*>): ArgumentResult<Either<L, R>> {
    ...
    override fun generateExamples(event: GlobalCommandEvent<*>): List<String> {
