<p style="text-align: center">
    ...
    <a href="https://github.com/discordkt/discordkt/releases/">
      <img alt="Version" src="https://img.shields.io/badge/Version-0.23.1--SNAPSHOT-%23E15ABA?label=Version&logo=GitHub">
    </a>
    <br>
...
dependencies {
    implementation("me.jakejmattson:DiscordKt:0.23.1-SNAPSHOT")
}
```
